...
export const CampaignPanel = ({ segments, defaultListId, canWrite, role }: CampaignPanelProps) => {
  ...
  if (!canWrite) {
    return (
      <p className="text-secondary">
        Your role ({role}) can read the newsletter and not aim one. Marketing and admins own this.
      </p>
    )
  }
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex flex-wrap gap-2">
        <Button variant="primary" onClick={() => setComposing(true)} disabled={segments.length === 0}>
          Aim a campaign
        </Button>
