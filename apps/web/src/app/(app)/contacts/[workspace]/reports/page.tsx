...
const ReportsOverview = async ({
  ...
  const link = (tab: string) => reportsPath(workspace, { tab, from: range.fromDay, to: range.toDay })
  ...
  return (
    <div className="flex min-w-0 flex-col gap-4">
      <ReportsHeader workspace={workspace} current="" from={range.fromDay} to={range.toDay} />
